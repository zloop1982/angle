...
#elif !ANGLE_SKIP_DXGI_1_2_CHECK
...
template <typename T>
void WriteIndexBufferTriangleFan(T *data, GLenum type, const GLvoid *indices, unsigned int numTris)
{
    switch (type)
    {
        case GL_NONE:   // Non-indexed draw
...
int Renderer11::getMaxTextureArrayLayers() const
{
    switch (mFeatureLevel)
    {
      ...
      case D3D_FEATURE_LEVEL_9_3:
      case D3D_FEATURE_LEVEL_9_2:
      case D3D_FEATURE_LEVEL_9_1: return 0; // unsupported
#endif // #if defined(ANGLE_PLATFORM_WINRT)
      default: UNREACHABLE();      return 0;
    }
}
