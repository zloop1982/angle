#include "pch.h"
#include "RotatingCubeXaml_UAMain.h"
...
RotatingCubeXaml_UAMain::~RotatingCubeXaml_UAMain()
{
...
void RotatingCubeXaml_UAMain::CreateWindowSizeDependentResources() 
{
...
void RotatingCubeXaml_UAMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Updates the application state once per frame.
void RotatingCubeXaml_UAMain::Update() 
{
	ProcessInput();
...
void RotatingCubeXaml_UAMain::ProcessInput()
{
...
void RotatingCubeXaml_UAMain::OnDeviceLost()
{
...
void RotatingCubeXaml_UAMain::OnDeviceRestored()
{
